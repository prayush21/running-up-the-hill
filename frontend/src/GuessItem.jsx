    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 right-0 pointer-events-none z-0">
                <div
                    className={cn("h-full opacity-30 transition-all duration-1000", getRankColor(guess.rank))}
            ...
            <div className="relative z-10 py-1.5 px-3 sm:py-2 flex items-center justify-between">
                ...
                <div className="flex flex-col items-end">
                    <div className="flex items-baseline space-x-1 sm:space-x-2">
                        <span className={cn("text-xl font-bold font-mono tracking-widest", guess.rank <= 300 ? "text-emerald-400" : guess.rank <= 1500 ? "text-amber-400" : "text-rose-400")}>
                            {guess.rank}
                        </span>
                        <span className="text-[10px] text-cream-dark opacity-50 font-mono">/ {guess.total_words}</span>
                    </div>
